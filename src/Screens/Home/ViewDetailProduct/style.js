...
import { Darkcolor, maintitle, primary, WhiteColor } from "../../../Utils/ColorScheme/Colors";
...
const styles=StyleSheet.create({
  ...
  tilespe:{
    fontSize:17,fontFamily:Regular,color:Darkcolor

  },
  banrd:{
    fontFamily:Regular,color:maintitle,fontSize:16,
    width:"70%"
  },
  btn:{
width:Dimensions.get('screen').width/2,
  ...
  ,btntitle:{
    fontSize:20,fontFamily:SemiBold,color:WhiteColor
  }
})
